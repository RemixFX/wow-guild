...
# Оглавление
 ...
 - [Документация сервера](https://github.com/RemixFX/wow-guild-api)
...
### Технологии: 
 ...
 - Самодельные хуки
 - Реализована авторизация через токен
 - Индикаторы загрузки контента
 - Обработка ошибок проводится преимущественно на сервере и поступает в единый интерфейс ошибок.
 
 ### Планы на будущее:
 - упорядочить некоторые компоненты, разбить на отдельные компоненты
 - адаптировать верстку и функционал под мобильные разрешения экрана
