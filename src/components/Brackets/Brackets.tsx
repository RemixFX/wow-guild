  ...
  return (
    <section className="brackets">
      ...
      <div className="bracket">
        ...
        {Object.entries(brackets).map(([raidID, raid]) =>
          <div className="bracket__raid_page_bracket" key={raidID}>
            {Object.entries(raid).map(([groupName, groupPlayers]) =>
                ...
                <div className="bracket__players">
                  ...
                  {groupPlayers.map((player) =>
                    <ul className="bracket__row_page_bracket" key={player.id}>
                      ...
                      <li className="bracket__cell">{player.ilvl ? player.ilvl : ""}</li>
                    </ul>
                  )}
